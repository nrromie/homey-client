...
const Footer = () => {
  return (
    <footer className="divide-y dark:bg-gray-800 dark:text-gray-100">
      <div className="flex flex-col justify-between py-10 w-11/12 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div className="lg:w-1/3">
          ...
          <p className='py-8'>Your trusted partner for home services.</p>
        </div>
      ...
      <div className="py-6 text-sm text-center dark:text-gray-400">© {new Date().getFullYear()} Homey Co. All rights reserved.</div>
    </footer>
  );
};
